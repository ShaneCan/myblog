...
I obtained my Master's degree in Transportation from Civil Aviation Flight University of China in 2024. Following that, I continued my academic journey at the [Chair of Software Technology (ST group)](https://tu-dresden.de/ing/informatik/smt/st) at Technische Universität Dresden, where I am pursuing my PhD under the guidance of [Prof. Uwe Aßmann](http://www1.inf.tu-dresden.de/~ua1/). I am also a member of the project [RTG 2947 „AirMetro“](https://tu-dresden.de/bu/verkehr/airmetro/rtg-2947-ueberblick). Currently, my research focus is ensuring cyber-physical consistency in digital twin simulations for Unmanned Aerial Vehicles (UAVs). With a deep-seated passion for the transportation sector, I am particularly interested in leveraging simulation to address and mitigate traffic safety challenges.
